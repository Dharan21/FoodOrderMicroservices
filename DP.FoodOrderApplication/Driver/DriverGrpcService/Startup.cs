using AutoMapper;
using DriverGrpcService.Services;
...
namespace DriverGrpcService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            DriverServices.BL.IocConfig.ConfigureServices(ref services);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcService<DriverGrpcProtoService>();
